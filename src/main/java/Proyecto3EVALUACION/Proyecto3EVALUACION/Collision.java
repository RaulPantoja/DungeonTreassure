...
public class Collision implements ICollision {
	...
	public Collision (JuegoController gp) {
		this.gp = gp;
	...
	/**
	 * Miramos si el jugador esta tocando algun objeto, y si lo esta haciendo devolvemos el index
	 */
		...
		for(int i = 0; i < gp.obj.length; i++) {
			if(gp.obj[i] != null) {
				...
				case "up":
					...
					//el metodo intersects nos dice si estos dos rectangulos se estan tocando entre ellos
